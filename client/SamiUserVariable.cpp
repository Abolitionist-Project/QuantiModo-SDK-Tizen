...
pLongitude = null;
pLocation = null;
pExperiment_start_time = null;
pExperiment_end_time = null;
pCreated_at = null;
pUpdated_at = null;
pOutcome = null;
pSources = null;
...
if(pExperiment_start_time != null) {
        
        delete pExperiment_start_time;
        pExperiment_start_time = null;
    }
if(pExperiment_end_time != null) {
        
        delete pExperiment_end_time;
        pExperiment_end_time = null;
    }
if(pCreated_at != null) {
...
JsonString* pLocationKey = new JsonString(L"location");
        ...
        delete pLocationKey;
JsonString* pExperiment_start_timeKey = new JsonString(L"experiment_start_time");
        IJsonValue* pExperiment_start_timeVal = null;
        pJsonObject->GetValue(pExperiment_start_timeKey, pExperiment_start_timeVal);
        if(pExperiment_start_timeVal != null) {
            
            pExperiment_start_time = new DateTime();
            jsonToValue(pExperiment_start_time, pExperiment_start_timeVal, L"DateTime", L"DateTime");
        }
        delete pExperiment_start_timeKey;
JsonString* pExperiment_end_timeKey = new JsonString(L"experiment_end_time");
        IJsonValue* pExperiment_end_timeVal = null;
        pJsonObject->GetValue(pExperiment_end_timeKey, pExperiment_end_timeVal);
        if(pExperiment_end_timeVal != null) {
            
            pExperiment_end_time = new DateTime();
            jsonToValue(pExperiment_end_time, pExperiment_end_timeVal, L"DateTime", L"DateTime");
        }
        delete pExperiment_end_timeKey;
...
SamiUserVariable::asJsonObject() {
    ...
    JsonString *pExperiment_start_timeKey = new JsonString(L"experiment_start_time");
    pJsonObject->Add(pExperiment_start_timeKey, toJson(getPExperimentStartTime(), "DateTime", ""));

    JsonString *pExperiment_end_timeKey = new JsonString(L"experiment_end_time");
    pJsonObject->Add(pExperiment_end_timeKey, toJson(getPExperimentEndTime(), "DateTime", ""));
...
Integer*
SamiUserVariable::getPUserId() {
    return pUser_id;
}
void
SamiUserVariable::setPUserId(Integer* pUser_id) {
...
Float*
SamiUserVariable::getPMinimumRecordedValue() {
    return pMinimum_recorded_value;
}
void
SamiUserVariable::setPMinimumRecordedValue(Float* pMinimum_recorded_value) {
...
DateTime*
SamiUserVariable::getPExperimentStartTime() {
    return pExperiment_start_time;
}
void
SamiUserVariable::setPExperimentStartTime(DateTime* pExperiment_start_time) {
    this->pExperiment_start_time = pExperiment_start_time;
}

DateTime*
SamiUserVariable::getPExperimentEndTime() {
    return pExperiment_end_time;
}
void
SamiUserVariable::setPExperimentEndTime(DateTime* pExperiment_end_time) {
    this->pExperiment_end_time = pExperiment_end_time;
}
