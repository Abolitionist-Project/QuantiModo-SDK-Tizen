...
SamiCredentialApi::credentialsGetWithCompletion(String* accessToken, Integer* userId, Integer* connectorId, String* attrKey, String* attrValue, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_4*, SamiError*)) {
...
SamiCredentialApi::credentialsPostWithCompletion(String* accessToken, SamiCredential* body, void (* success)(SamiInline_response_200_19*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_19* 
SamiCredentialApi::credentialsIdGetWithCompletion(Integer* _id, String* attrKey, String* accessToken, void (* success)(SamiInline_response_200_19*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCredentialApi::credentialsIdPutWithCompletion(Integer* _id, String* attrKey, String* accessToken, SamiCredential* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiCredentialApi::credentialsIdDeleteWithCompletion(Integer* _id, String* attrKey, String* accessToken, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
