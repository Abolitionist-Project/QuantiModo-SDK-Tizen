...
SamiCorrelationApi::correlationsPostWithCompletion(String* accessToken, SamiCorrelation* body, void (* success)(SamiInline_response_200_18*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_18* 
SamiCorrelationApi::correlationsIdGetWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_18*, SamiError*)) {
  client = new SamiApiClient();
...
SamiCorrelationApi::correlationsIdPutWithCompletion(Integer* _id, String* accessToken, SamiCorrelation* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiCorrelationApi::correlationsIdDeleteWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
