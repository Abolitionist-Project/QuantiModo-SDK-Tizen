...
SamiMeasurement::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pStart_timeVal != null) {
            ...
            pStart_time = new Integer();
            jsonToValue(pStart_time, pStart_timeVal, L"Integer", L"Integer");
        }
...
SamiMeasurement::asJsonObject() {
    ...
    JsonString *pStart_timeKey = new JsonString(L"start_time");
    pJsonObject->Add(pStart_timeKey, toJson(getPStartTime(), "Integer", ""));
...
void
SamiMeasurement::setPStartTime(Integer* pStart_time) {
