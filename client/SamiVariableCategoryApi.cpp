...
variableCategoriesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_23* out = new SamiInline_response_200_23();
    jsonToValue(out, pJson, L"SamiInline_response_200_23*", L"SamiInline_response_200_23");
...
SamiVariableCategoryApi::variableCategoriesGetWithCompletion(String* name, Long* fillingValue, Long* maximumAllowedValue, Long* minimumAllowedValue, Integer* durationOfAction, Integer* onsetDelay, String* combinationOperation, Integer* updated, Boolean* causeOnly, Integer* public, Boolean* outcome, String* createdAt, String* updatedAt, String* imageUrl, Integer* defaultUnitId, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_23*, SamiError*)) {
...
variableCategoriesPostProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_24* out = new SamiInline_response_200_24();
    jsonToValue(out, pJson, L"SamiInline_response_200_24*", L"SamiInline_response_200_24");
...
SamiVariableCategoryApi::variableCategoriesPostWithCompletion(SamiVariableCategory* body, void (* success)(SamiInline_response_200_24*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_24* 
SamiVariableCategoryApi::variableCategoriesIdGetWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_24*, SamiError*)) {
  client = new SamiApiClient();
...
SamiVariableCategoryApi::variableCategoriesIdPutWithCompletion(Integer* _id, SamiVariableCategory* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiVariableCategoryApi::variableCategoriesIdDeleteWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
