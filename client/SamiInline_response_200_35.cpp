...
SamiInline_response_200_35::SamiInline_response_200_35() {
    init();
}
...
void
SamiInline_response_200_35::init() {
    pData = null;
    pSuccess = null;
...
void
SamiInline_response_200_35::cleanup() {
    if(pData != null) {
...
SamiInline_response_200_35::fromJson(String* json) {
    this->cleanup();
...
void
SamiInline_response_200_35::fromJsonObject(IJsonValue* pJson) {
...
SamiInline_response_200_35::SamiInline_response_200_35(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String
SamiInline_response_200_35::asJson ()
{
...
JsonObject*
SamiInline_response_200_35::asJsonObject() {
...
SamiVariable*
SamiInline_response_200_35::getPData() {
    return pData;
}
void
SamiInline_response_200_35::setPData(SamiVariable* pData) {
    this->pData = pData;
}

Boolean*
SamiInline_response_200_35::getPSuccess() {
    return pSuccess;
}
void
SamiInline_response_200_35::setPSuccess(Boolean* pSuccess) {
