...
SamiAggregatedCorrelationApi::aggregatedCorrelationsPostWithCompletion(SamiAggregatedCorrelation* body, void (* success)(SamiInline_response_200_1*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_1* 
SamiAggregatedCorrelationApi::aggregatedCorrelationsIdGetWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_1*, SamiError*)) {
  client = new SamiApiClient();
...
SamiAggregatedCorrelationApi::aggregatedCorrelationsIdPutWithCompletion(Integer* _id, SamiAggregatedCorrelation* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiAggregatedCorrelationApi::aggregatedCorrelationsIdDeleteWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
