...
SamiConnectionApi::connectionsPostWithCompletion(SamiConnection* body, void (* success)(SamiInline_response_200_4*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_4* 
SamiConnectionApi::connectionsIdGetWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_4*, SamiError*)) {
  client = new SamiApiClient();
...
SamiConnectionApi::connectionsIdPutWithCompletion(Integer* _id, SamiConnection* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiConnectionApi::connectionsIdDeleteWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
