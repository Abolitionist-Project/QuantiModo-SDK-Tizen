...
userVariablesPostProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_30* out = new SamiInline_response_200_30();
    jsonToValue(out, pJson, L"SamiInline_response_200_30*", L"SamiInline_response_200_30");
...
SamiUserVariableApi::userVariablesPostWithCompletion(String* accessToken, SamiUserVariable* body, void (* success)(SamiInline_response_200_30*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_30* 
SamiUserVariableApi::userVariablesIdGetWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_30*, SamiError*)) {
  client = new SamiApiClient();
...
SamiUserVariableApi::userVariablesIdPutWithCompletion(Integer* _id, String* accessToken, SamiUserVariable* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiUserVariableApi::userVariablesIdDeleteWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
