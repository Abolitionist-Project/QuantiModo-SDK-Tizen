...
variableUserSourcesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_25* out = new SamiInline_response_200_25();
    jsonToValue(out, pJson, L"SamiInline_response_200_25*", L"SamiInline_response_200_25");
...
SamiVariableUserSourceApi::variableUserSourcesGetWithCompletion(Integer* variableId, Integer* userId, Integer* timestamp, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_25*, SamiError*)) {
...
SamiVariableUserSourceApi::variableUserSourcesPostWithCompletion(SamiVariableUserSource* body, void (* success)(SamiInline_response_200_26*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_26* 
SamiVariableUserSourceApi::variableUserSourcesIdGetWithCompletion(Integer* _id, Integer* sourceId, void (* success)(SamiInline_response_200_26*, SamiError*)) {
  client = new SamiApiClient();
...
SamiVariableUserSourceApi::variableUserSourcesIdPutWithCompletion(Integer* _id, Integer* sourceId, SamiVariableUserSource* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiVariableUserSourceApi::variableUserSourcesIdDeleteWithCompletion(Integer* _id, Integer* sourceId, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
