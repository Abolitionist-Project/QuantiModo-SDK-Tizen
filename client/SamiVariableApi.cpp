...
variablesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_34* out = new SamiInline_response_200_34();
    jsonToValue(out, pJson, L"SamiInline_response_200_34*", L"SamiInline_response_200_34");
...
variablesPostProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_35* out = new SamiInline_response_200_35();
    jsonToValue(out, pJson, L"SamiInline_response_200_35*", L"SamiInline_response_200_35");
...
SamiVariableApi::variablesPostWithCompletion(String* accessToken, SamiVariable* body, void (* success)(SamiInline_response_200_35*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_35* 
SamiVariableApi::variablesIdGetWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_35*, SamiError*)) {
  client = new SamiApiClient();
...
SamiVariableApi::variablesIdPutWithCompletion(Integer* _id, String* accessToken, SamiVariable* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiVariableApi::variablesIdDeleteWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
