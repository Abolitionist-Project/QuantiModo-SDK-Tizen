...
IList*
SamiInline_response_200_5::getPData() {
    return pData;
}
void
SamiInline_response_200_5::setPData(IList* pData) {
    this->pData = pData;
}

Boolean*
SamiInline_response_200_5::getPSuccess() {
    return pSuccess;
}
void
SamiInline_response_200_5::setPSuccess(Boolean* pSuccess) {
