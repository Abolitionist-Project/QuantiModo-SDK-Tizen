...
SamiInline_response_200_11* 
SamiMeasurementApi::measurementsPostWithCompletion(SamiMeasurementPost* body, void (* success)(SamiInline_response_200_11*, SamiError*)) {
  client = new SamiApiClient();
...
SamiFile* 
SamiMeasurementApi::measurementsCsvGetWithCompletion( void (* success)(SamiFile*, SamiError*)) {
  client = new SamiApiClient();
...
Integer* 
SamiMeasurementApi::measurementsRequestCsvPostWithCompletion( void (* success)(Integer*, SamiError*)) {
  client = new SamiApiClient();
...
SamiMeasurementApi::measurementsIdGetWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_12*, SamiError*)) {
  client = new SamiApiClient();
...
SamiMeasurementApi::measurementsIdPutWithCompletion(Integer* _id, SamiMeasurement* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiMeasurementApi::measurementsIdDeleteWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
