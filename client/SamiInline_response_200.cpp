...
JsonString* pDataKey = new JsonString(L"data");
        ...
        if(pDataVal != null) {
            ...
            jsonToValue(pData, pDataVal, L"IList", L"SamiTrackingReminderNotification");
        }
        delete pDataKey;
    }
}
...
SamiInline_response_200::asJsonObject() {
    ...
    JsonString *pDataKey = new JsonString(L"data");
    pJsonObject->Add(pDataKey, toJson(getPData(), "SamiTrackingReminderNotification", "array"));

    return pJsonObject;
}

Boolean*
SamiInline_response_200::getPSuccess() {
    return pSuccess;
}
void
SamiInline_response_200::setPSuccess(Boolean* pSuccess) {
    this->pSuccess = pSuccess;
}

IList*
SamiInline_response_200::getPData() {
    return pData;
}
void
SamiInline_response_200::setPData(IList* pData) {
    this->pData = pData;
}
