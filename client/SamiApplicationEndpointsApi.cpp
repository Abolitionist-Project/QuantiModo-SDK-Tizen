...
void
applicationConnectionsGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
SamiApplicationEndpointsApi::applicationConnectionsGetWithCompletion(String* accessToken, Integer* connectorId, String* connectStatus, String* connectError, String* updateRequestedAt, String* updateStatus, String* updateError, String* lastSuccessfulUpdatedAt, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_3*, SamiError*)) {
  ...
  String url(L"/application/connections");
...
void
applicationCredentialsGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationCredentialsGetWithCompletion(String* accessToken, Integer* connectorId, String* attrKey, String* attrValue, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_4*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&applicationCredentialsGetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/application/credentials");
...
void
applicationMeasurementsGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationMeasurementsGetWithCompletion(String* accessToken, String* clientId, Integer* connectorId, Integer* variableId, Integer* sourceId, String* startTime, Long* value, Integer* unitId, Long* originalValue, Integer* originalUnitId, Integer* duration, String* note, Long* latitude, Long* longitude, String* location, String* createdAt, String* updatedAt, String* error, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_5*, SamiError*)) {
  ...
  client->success(&applicationMeasurementsGetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/application/measurements");
...
void
applicationTrackingRemindersGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationTrackingRemindersGetWithCompletion(String* accessToken, String* clientId, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_6*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&applicationTrackingRemindersGetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/application/trackingReminders");
...
void
applicationUpdatesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationUpdatesGetWithCompletion(String* accessToken, Integer* connectorId, Integer* numberOfMeasurements, Boolean* success, String* message, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_7*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&applicationUpdatesGetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/application/updates");
...
void
applicationUserVariableRelationshipsGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationUserVariableRelationshipsGetWithCompletion(String* accessToken, Integer* _id, String* confidenceLevel, Long* confidenceScore, String* direction, Integer* durationOfAction, String* errorMessage, Integer* onsetDelay, Integer* outcomeVariableId, Integer* predictorVariableId, Integer* predictorUnitId, Long* sinnRank, String* strengthLevel, Long* strengthScore, String* vote, Long* valuePredictingHighOutcome, Long* valuePredictingLowOutcome, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_8*, SamiError*)) {
  ...
  String url(L"/application/userVariableRelationships");
...
void
applicationUserVariablesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationUserVariablesGetWithCompletion(String* accessToken, String* clientId, Integer* parentId, Integer* variableId, Integer* defaultUnitId, Long* minimumAllowedValue, Long* maximumAllowedValue, Long* fillingValue, Integer* joinWith, Integer* onsetDelay, Integer* durationOfAction, Integer* variableCategoryId, Integer* updated, Integer* public, Boolean* causeOnly, String* fillingType, Integer* numberOfMeasurements, Integer* numberOfProcessedMeasurements, Integer* measurementsAtLastAnalysis, Integer* lastUnitId, Integer* lastOriginalUnitId, Integer* lastOriginalValue, Long* lastValue, Long* lastOriginalValue2, Integer* lastSourceId, Integer* numberOfCorrelations, String* status, String* errorMessage, String* lastSuccessfulUpdateTime, Long* standardDeviation, Long* variance, Long* minimumRecordedValue, Long* maximumRecordedValue, Long* mean, Long* median, Integer* mostCommonUnitId, Long* mostCommonValue, Long* numberOfUniqueDailyValues, Integer* numberOfChanges, Long* skewness, Long* kurtosis, Long* latitude, Long* longitude, String* location, String* createdAt, String* updatedAt, Boolean* outcome, String* sources, Integer* earliestSourceTime, Integer* latestSourceTime, Integer* earliestMeasurementTime, Integer* latestMeasurementTime, Integer* earliestFillingTime, Integer* latestFillingTime, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_9*, SamiError*)) {
  ...
  queryParams->Construct();
    ...
    queryParams->Add(new String("last_original_value"), lastOriginalValue2);
  ...
  String url(L"/application/userVariables");
...
void
applicationVariableUserSourcesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationVariableUserSourcesGetWithCompletion(String* accessToken, Integer* variableId, Integer* timestamp, Integer* earliestMeasurementTime, Integer* latestMeasurementTime, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_10*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&applicationVariableUserSourcesGetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/application/variableUserSources");
...
void
applicationVotesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiApplicationEndpointsApi::applicationVotesGetWithCompletion(String* accessToken, String* clientId, Integer* causeId, Integer* effectId, Integer* value, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_11*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&applicationVotesGetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
  ...
  String url(L"/application/votes");
