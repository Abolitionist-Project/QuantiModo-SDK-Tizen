...
JsonString* pDataKey = new JsonString(L"data");
        ...
        if(pDataVal != null) {
            ...
            jsonToValue(pData, pDataVal, L"IList", L"SamiConnection");
        }
        delete pDataKey;
    }
}
...
SamiInline_response_200_3::asJsonObject() {
    ...
    JsonString *pDataKey = new JsonString(L"data");
    pJsonObject->Add(pDataKey, toJson(getPData(), "SamiConnection", "array"));

    return pJsonObject;
}

Boolean*
SamiInline_response_200_3::getPSuccess() {
    return pSuccess;
}
void
SamiInline_response_200_3::setPSuccess(Boolean* pSuccess) {
    this->pSuccess = pSuccess;
}

IList*
SamiInline_response_200_3::getPData() {
    return pData;
}
void
SamiInline_response_200_3::setPData(IList* pData) {
    this->pData = pData;
}
