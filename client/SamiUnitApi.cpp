...
unitsGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_26* out = new SamiInline_response_200_26();
    jsonToValue(out, pJson, L"SamiInline_response_200_26*", L"SamiInline_response_200_26");
...
SamiUnitApi::unitsGetWithCompletion(String* accessToken, String* clientId, String* name, String* abbreviatedName, Integer* categoryId, Long* minimumValue, Long* maximumValue, Integer* updated, Integer* defaultUnitId, Long* multiply, Long* add, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_26*, SamiError*)) {
...
SamiUnitApi::unitsPostWithCompletion(String* accessToken, SamiUnit* body, void (* success)(SamiInline_response_200_27*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_27* 
SamiUnitApi::unitsIdGetWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_27*, SamiError*)) {
  client = new SamiApiClient();
...
SamiUnitApi::unitsIdPutWithCompletion(Integer* _id, String* accessToken, SamiUnit* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiUnitApi::unitsIdDeleteWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
