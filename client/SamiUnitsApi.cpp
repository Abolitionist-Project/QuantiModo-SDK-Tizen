...
IList* 
SamiUnitsApi::v1UnitsGetWithCompletion(String* unitName, String* abbreviatedUnitName, String* categoryName, void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();
...
IList* 
SamiUnitsApi::v1UnitsVariableGetWithCompletion(String* unitName, String* abbreviatedUnitName, String* categoryName, String* variable, void (* success)(IList*, SamiError*)) {
  client = new SamiApiClient();
