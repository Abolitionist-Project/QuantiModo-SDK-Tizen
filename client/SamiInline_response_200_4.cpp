...
SamiConnection*
SamiInline_response_200_4::getPData() {
    return pData;
}
void
SamiInline_response_200_4::setPData(SamiConnection* pData) {
    this->pData = pData;
}

Boolean*
SamiInline_response_200_4::getPSuccess() {
    return pSuccess;
}
void
SamiInline_response_200_4::setPSuccess(Boolean* pSuccess) {
