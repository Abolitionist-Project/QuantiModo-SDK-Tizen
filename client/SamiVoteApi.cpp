...
void
votesGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
...
void
votesPostProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void
votesIdGetProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
SamiInline_response_200_30* 
SamiVoteApi::votesIdGetWithCompletion(Integer* _id, void (* success)(SamiInline_response_200_30*, SamiError*)) {
  client = new SamiApiClient();

  client->success(&votesIdGetProcessor, (void(*)(void*, SamiError*))success);
  HashMap* headerParams = new HashMap(SingleObjectDeleter);
  headerParams->Construct();
...
void
votesIdPutProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
...
void
votesIdDeleteProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  int code = pHttpResponse->GetHttpStatusCode();
