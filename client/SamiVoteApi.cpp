...
SamiVoteApi::votesGetWithCompletion(String* accessToken, String* clientId, Integer* userId, Integer* causeId, Integer* effectId, Integer* value, String* createdAt, String* updatedAt, Integer* limit, Integer* offset, String* sort, void (* success)(SamiInline_response_200_11*, SamiError*)) {
...
votesPostProcessor(HttpResponse* pHttpResponse, void (* handler)(void*, SamiError*)) {
  ...
  if(code >= 200 && code < 300) {
    ...
    SamiInline_response_200_36* out = new SamiInline_response_200_36();
    jsonToValue(out, pJson, L"SamiInline_response_200_36*", L"SamiInline_response_200_36");
...
SamiVoteApi::votesPostWithCompletion(String* accessToken, SamiVote* body, void (* success)(SamiInline_response_200_36*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_36* 
SamiVoteApi::votesIdGetWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_36*, SamiError*)) {
  client = new SamiApiClient();
...
SamiVoteApi::votesIdPutWithCompletion(Integer* _id, String* accessToken, SamiVote* body, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
...
SamiInline_response_200_2* 
SamiVoteApi::votesIdDeleteWithCompletion(Integer* _id, String* accessToken, void (* success)(SamiInline_response_200_2*, SamiError*)) {
  client = new SamiApiClient();
